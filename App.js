...
const App = () => {
  return (
    <Stack.Navigator>
      <Stack.Screen name="QuanLy" component={QuanLyCuaHang} options={{title:"Quản lý cửa hàng"}}/>
      <Stack.Screen name="Add" component={Add} />
      <Stack.Screen name="Details" component={Details}options={{title:"Chi tiết cửa hàng"}} />
      <Stack.Screen name="Edit" component={Edit}options={{title:"Chỉnh sửa cửa hàng"}}  />
    </Stack.Navigator>
